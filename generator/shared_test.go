...
func TestDefaultImports(t *testing.T) {
	for i, toPin := range []struct {
	...
	}{
		{
			...
			Opts:  &GenOpts{},
			Expected: map[string]string{
				"models": "github.com/cloudentity/go-swagger/generator/models",
			},
		},
		{
			...
			Expected: map[string]string{
				"ext":    "github.com/cloudentity/go-swagger/generator/ext",
				"models": "github.com/cloudentity/go-swagger/generator/models",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/cloudentity/go-swagger/generator/target/bespoke",
			},
		},
		{
		...
		// issue #2362
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/cloudentity/go-swagger/generator/target/bespoke",
				"auth":    "github.com/cloudentity/go-swagger/generator/auth",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"models": "github.com/cloudentity/go-swagger/generator/target/models",
				"auth":   "target/auth",
			},
		},
	} {
