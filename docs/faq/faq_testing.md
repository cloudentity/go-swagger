...
Originally from issue [#787](https://github.com/cloudentity/go-swagger/issues/787).
...
Originally from issue [#719](https://github.com/cloudentity/go-swagger/issues/719).
