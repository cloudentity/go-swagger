...
import (
	...
	"github.com/cloudentity/go-swagger/examples/file-server/restapi/operations"
	"github.com/cloudentity/go-swagger/examples/file-server/restapi/operations/uploads"
)
