...
import (
	...
	"github.com/cloudentity/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/cloudentity/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
