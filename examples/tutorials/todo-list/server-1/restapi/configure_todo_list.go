...
import (
	...
	"github.com/cloudentity/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/cloudentity/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
