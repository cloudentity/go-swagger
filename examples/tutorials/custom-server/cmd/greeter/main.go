...
import (
	...
	"github.com/cloudentity/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/cloudentity/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
